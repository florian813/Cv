...
<div id="div-photo" style="width=device-width ; background:#273746 ;">
    ...
    <div style="margin-left:2% ; width:10%;">
		...
		version="1.0">
			...
			<use xlink:href="#left" transform="matrix(-1,0,0,1,500,0)"/>
			<metadata>
			<rdf:RDF>
  			<cc:Work>
...
<div style="width=device-width" >
    <div style="margin-left:3%">
        ...
        <span class="opacity-50" style="margin-left:1%">specialty: Computer Science and Digital Sciences (ISN)<span></p>
