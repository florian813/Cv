	...
	<div id="div-photo" style="width=device-width ; background:#273746 ; display:none;">
		...
		<div id="photocv">
			...
			<div id="informations">
			<svg id="button_email" xmlns="http://www.w3.org/2000/svg" width="4%" height="4%" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
  				<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
			</svg>
				<span id="email" style="display:none;margin-left:0.6%">florianleborgne813@gmail.com</span>

			<svg id="button_tel"xmlns="http://www.w3.org/2000/svg" width="4%" height="4%" style="margin-left:1%;" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
			...
			<span id="tel" style="display:none;margin-left:0.6%">06 65 97 16 90</span>

			<svg id="button_date" xmlns="http://www.w3.org/2000/svg" style="margin-left:1%" width="4%" height="4%" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
  				<path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
			</svg>
			<span id="date" style="display:none;margin-left:0.6%;">07/01/2001</span>

			<svg id="button_adresse" style="margin-left:1%" xmlns="http://www.w3.org/2000/svg" width="4%" height="4%" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
  				<path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5z"/>
			</svg>
			<span id="adresse" style="display:none;margin-left:0.6%">31 rue de la gare ,Beutin 62170</span>

			<svg id="button_permis" xmlns="http://www.w3.org/2000/svg" style="margin-left:1%" width="4%" height="4%" fill="currentColor" class="bi bi-credit-card-2-front" viewBox="0 0 16 16">
  				<path d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
  				<path d="M2 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1zm0 3a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5zm3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5z"/>
			</svg>
			<span id="permis" style="display:none;margin-left:0.6%">Permis B</span>
				
			<svg id="button_voiture" style="margin-left:1%" width="4%" height="4%" fill="currentColor" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
  ...
  <metadata>
    <rdf:RDF>
      <cc:Work>
        ...
        <cc:permits rdf:resource="http://creativecommons.org/ns#DerivativeWorks"/></cc:License></rdf:RDF></metadata>
			...
			<span id="voiture" style="display:none;margin-left:0.6%;">Véhicule personnel</span>
		</div> 
	...
	<div id="diplomes" style="width=device-width;display:none;" >
		<div style="margin-left:3%">
			...
			<p>
                ...
                Bac S SI <a href="https://www.google.fr/maps/place/School+Eug%C3%A8ne-Woillez/@50.465282,1.7642147,17z/data=!3m1!4b1!4m5!3m4!1s0x47ddc66415a60755:0xb155ef67daa15148!8m2!3d50.4652375!4d1.7663617" target="_blank">Lycée Eugène Woillez Montreuil,France</a> / De septembre 2016 à juillet 2019<br>
			<span class="opacity-50" style="margin-left:1%">Spécialité: Informatique et Sciences du Numérique (ISN)</span></p>
			<p>
                <span class="material-symbols-sharp" style="margin-top: 10px">
                    circle
                </span>
                Brevet des collèges <a href="https://www.google.fr/maps/place/Middle+School+Du+Bras+D'or/@50.4557918,1.7567172,17z/data=!3m1!4b1!4m5!3m4!1s0x47ddc686488ae1bd:0xca2a187a7ee9f7c0!8m2!3d50.4557884!4d1.7589059" target="_blank">Collège du Bras d'Or Ecuires,France</a> / De septembre 2012 à juillet 2016</p>
		</div>
		<hr>
	</div>
	...
	<div id="experiences" style="width=device-width;display:none;">
		<div style="margin-left:3%">
	...
	<div id="langues" style="width=device-width;display:none;">
		<div style="margin-left:3%;">
			<h2>Langues</h2>
  ...
  <div class="rt-container" style="overflow-y:auto;height:200px">
	...
	<div id="interet" style="width=device-width;display:none;">
		<div style="margin-left:3%">
...
<div id="informatiques" style="width=device-width;display:none;">
