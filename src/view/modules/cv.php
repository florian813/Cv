...
hr{width:device-width
	...
	<div id="div-photo" style="width=device-width ; background:#273746 ; margin-top:-0.9%">
		...
		<div style="margin-left:2% ; width:10%;">
			...
			<svg style="margin-left:1.80%" width="4%" height="4%" fill="currentColor" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
