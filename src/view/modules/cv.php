...
hr{width:device-width
	...
	<div id="div-photo" style="width=device-width ; background:#273746 ; margin-top:1%">

		<div style="margin-left:3.4% ; height:5% ; width:9.4%;background:black;">
			<img src="./img/photo_cv.jpg" class="rounded-circle" style="width: 100% ; margin-top: 3%;"></img>
		</div>
		...
		<div style="margin-left: ; margin-top:-6.8% ; background:green ;width=device-width; text-transform: uppercase;text:100% ">
			...
			<div>
			<svg xmlns="http://www.w3.org/2000/svg" width="2%" height="2%" style=";" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
			...
			<div>
			<svg xmlns="http://www.w3.org/2000/svg" style="" width="2%" height="2%" fill="currentColor" class="bi bi-credit-card-2-front" viewBox="0 0 16 16">
			...
			<div>
			<img src="./img/logo-vehicule.png" style="width: 2% ;"></img>
			Véhicule personnel
			</div>
			<center>
		</div>
